    ...
    public partial class StudentInvite : System.Web.UI.Page
    {
        ...
        protected void btnUpdateStatus_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string roomid = gvr.Cells[0].Text;
                string studentid = gvr.Cells[1].Text;
                string studentemail = gvr.Cells[2].Text;
                string teacherid = gvr.Cells[3].Text;
                string teacheremail = gvr.Cells[4].Text;
                string subjectname = gvr.Cells[5].Text;

                using (MySqlConnection con = new MySqlConnection(ConfigurationManager.ConnectionStrings["MySqlConnection"].ConnectionString))
                {
                    con.Open();
                    ...
                    using (MySqlCommand checkCmd = new MySqlCommand(checkQuery, con))
                    {
                        ...
                        {
                            ShowErrorMessage("The Student has already been invited");
                        }
                    }
                }
            }
